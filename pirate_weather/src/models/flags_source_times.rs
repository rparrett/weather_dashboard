...
pub struct FlagsSourceTimes {
    ...
    /// The time the RTMA-RU model was last updated.
    #[serde(rename = "rtma_ru", skip_serializing_if = "Option::is_none")]
    pub rtma_ru: Option<String>,
    ...
    /// The time the DWD MOSMIX model was last updated.
    #[serde(rename = "dwd_mosmix", skip_serializing_if = "Option::is_none")]
    pub dwd_mosmix: Option<String>,
    /// The time the ECMWF IFS model was last updated.
    #[serde(rename = "ecmwf_ifs", skip_serializing_if = "Option::is_none")]
    pub ecmwf_ifs: Option<String>,

...
pub struct Currently {
    ...
    /// The amount of near-surface smoke in ug/m^3. Only returned when version>2.
    ...
    /// The ice precipitation that has accumulated so far during the day, from midnight until the forecast request time. Only returned when version>2.
    #[serde(rename = "currentDayIce", skip_serializing_if = "Option::is_none")]
    pub current_day_ice: Option<f64>,
    /// The liquid precipitation that has accumulated so far during the day, from midnight until the forecast request time. Only returned when version>2.
    #[serde(rename = "currentDayLiquid", skip_serializing_if = "Option::is_none")]
    pub current_day_liquid: Option<f64>,
    /// The snow precipitation that has accumulated so far during the day, from midnight until the forecast request time. Only returned when version>2.

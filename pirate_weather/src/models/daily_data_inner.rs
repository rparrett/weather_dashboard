...
pub struct DailyDataInner {
    ...
    /// The maximum intensity of rain precipitation. Only returned when version>1.
    #[serde(rename = "rainIntensityMax", skip_serializing_if = "Option::is_none")]
    pub rain_intensity_max: Option<f64>,
    ...
    /// The maximum intensity of snow precipitation. Only returned when version>1.
    #[serde(rename = "snowIntensityMax", skip_serializing_if = "Option::is_none")]
    pub snow_intensity_max: Option<f64>,
    ...
    /// The maximum intensity of ice precipitation. Only returned when version>1.
    #[serde(rename = "iceIntensityMax", skip_serializing_if = "Option::is_none")]
    pub ice_intensity_max: Option<f64>,
...
impl DailyDataInner {
    pub fn new() -> DailyDataInner {
        DailyDataInner {
            ...
            snow_intensity: None,
            snow_intensity_max: None,
            ice_intensity: None,
            ice_intensity_max: None,

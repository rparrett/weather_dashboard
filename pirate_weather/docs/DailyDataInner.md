...
**rain_intensity_max** | Option<**f64**> | The maximum intensity of rain precipitation. Only returned when version>1. | [optional]
**snow_intensity** | Option<**f64**> | The intensity of snow precipitation. Only returned when version>1. | [optional]
**snow_intensity_max** | Option<**f64**> | The maximum intensity of snow precipitation. Only returned when version>1. | [optional]
**ice_intensity** | Option<**f64**> | The intensity of ice precipitation. Only returned when version>1. | [optional]
**ice_intensity_max** | Option<**f64**> | The maximum intensity of ice precipitation. Only returned when version>1. | [optional]
...
**solar_max** | Option<**i32**> | The time when the maximum solar occurs in UNIX format. Only returned when version>1. | [optional]
